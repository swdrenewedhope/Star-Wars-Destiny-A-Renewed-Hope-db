...
class Version20171003070946 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS oauth2_access_token (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, user_id INT DEFAULT NULL, token VARCHAR(255) NOT NULL, expires_at INT DEFAULT NULL, scope VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_454D96735F37A13B (token), INDEX IDX_454D967319EB6921 (client_id), INDEX IDX_454D9673A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS affiliation (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(1024) NOT NULL, is_primary TINYINT(1) NOT NULL, UNIQUE INDEX affiliation_code_idx (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS oauth2_auth_code (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, user_id INT DEFAULT NULL, token VARCHAR(255) NOT NULL, redirect_uri LONGTEXT NOT NULL, expires_at INT DEFAULT NULL, scope VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_1D2905B55F37A13B (token), INDEX IDX_1D2905B519EB6921 (client_id), INDEX IDX_1D2905B5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS card (id INT AUTO_INCREMENT NOT NULL, set_id INT DEFAULT NULL, type_id INT DEFAULT NULL, subtype_id INT DEFAULT NULL, faction_id INT DEFAULT NULL, affiliation_id INT DEFAULT NULL, rarity_id INT DEFAULT NULL, reprint_of INT DEFAULT NULL, position SMALLINT NOT NULL, code VARCHAR(255) NOT NULL, ttscardid VARCHAR(255) DEFAULT NULL, name VARCHAR(50) NOT NULL, subtitle VARCHAR(50) DEFAULT NULL, cost SMALLINT DEFAULT NULL, health SMALLINT DEFAULT NULL, points VARCHAR(20) DEFAULT NULL, text LONGTEXT DEFAULT NULL, date_creation DATETIME NOT NULL, date_update DATETIME NOT NULL, deck_limit SMALLINT DEFAULT NULL, flavor LONGTEXT DEFAULT NULL, illustrator VARCHAR(255) DEFAULT NULL, is_unique TINYINT(1) NOT NULL, has_die TINYINT(1) NOT NULL, has_errata TINYINT(1) NOT NULL, INDEX IDX_161498D310FB0D18 (set_id), INDEX IDX_161498D3C54C8C93 (type_id), INDEX IDX_161498D38E2E245C (subtype_id), INDEX IDX_161498D34448F8DA (faction_id), INDEX IDX_161498D3CB94D64E (affiliation_id), INDEX IDX_161498D3F3747573 (rarity_id), INDEX IDX_161498D31C95D357 (reprint_of), INDEX card_name_idx (name), UNIQUE INDEX card_code_idx (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS oauth2_client (id INT AUTO_INCREMENT NOT NULL, random_id VARCHAR(255) NOT NULL, redirect_uris LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', secret VARCHAR(255) NOT NULL, allowed_grant_types LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS collection (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_FC4D6532A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS collectionslot (id INT AUTO_INCREMENT NOT NULL, collection_id INT DEFAULT NULL, card_id INT DEFAULT NULL, quantity SMALLINT NOT NULL, dice SMALLINT NOT NULL, INDEX IDX_49EC96F9514956FD (collection_id), INDEX IDX_49EC96F94ACC9A20 (card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS comment (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, decklist_id INT DEFAULT NULL, text LONGTEXT NOT NULL, date_creation DATETIME NOT NULL, is_hidden TINYINT(1) NOT NULL, INDEX IDX_9474526CA76ED395 (user_id), INDEX IDX_9474526CF4E9531B (decklist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS deck (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, affiliation_id INT DEFAULT NULL, last_set_id INT DEFAULT NULL, parent_decklist_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, date_update DATETIME NOT NULL, description_md LONGTEXT DEFAULT NULL, problem VARCHAR(255) DEFAULT NULL, tags VARCHAR(4000) DEFAULT NULL, major_version INT NOT NULL, minor_version INT NOT NULL, INDEX IDX_4FAC3637A76ED395 (user_id), INDEX IDX_4FAC3637CB94D64E (affiliation_id), INDEX IDX_4FAC36379AFC8FC2 (last_set_id), INDEX IDX_4FAC36379FC5416B (parent_decklist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS deckchange (id INT AUTO_INCREMENT NOT NULL, deck_id INT DEFAULT NULL, date_creation DATETIME NOT NULL, variation VARCHAR(1024) NOT NULL, is_saved TINYINT(1) NOT NULL, version VARCHAR(8) DEFAULT NULL, INDEX IDX_B32E853111948DC (deck_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS decklist (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, affiliation_id INT DEFAULT NULL, last_set_id INT DEFAULT NULL, parent_deck_id INT DEFAULT NULL, precedent_decklist_id INT DEFAULT NULL, predominant_faction_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, name_canonical VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, date_update DATETIME NOT NULL, description_md LONGTEXT DEFAULT NULL, description_html LONGTEXT DEFAULT NULL, signature VARCHAR(32) NOT NULL, nb_votes INT NOT NULL, nb_favorites INT NOT NULL, nb_comments INT NOT NULL, version VARCHAR(8) NOT NULL, INDEX IDX_ED030EC6A76ED395 (user_id), INDEX IDX_ED030EC6CB94D64E (affiliation_id), INDEX IDX_ED030EC69AFC8FC2 (last_set_id), INDEX IDX_ED030EC663513C9A (parent_deck_id), INDEX IDX_ED030EC6C386FA95 (precedent_decklist_id), INDEX IDX_ED030EC6BCFB7B5E (predominant_faction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS favorite (decklist_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_68C58ED9F4E9531B (decklist_id), INDEX IDX_68C58ED9A76ED395 (user_id), PRIMARY KEY(decklist_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS vote (decklist_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_5A108564F4E9531B (decklist_id), INDEX IDX_5A108564A76ED395 (user_id), PRIMARY KEY(decklist_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS decklistslot (id INT AUTO_INCREMENT NOT NULL, decklist_id INT DEFAULT NULL, card_id INT DEFAULT NULL, quantity SMALLINT NOT NULL, dice SMALLINT NOT NULL, INDEX IDX_2071B1F4E9531B (decklist_id), INDEX IDX_2071B14ACC9A20 (card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS deckslot (id INT AUTO_INCREMENT NOT NULL, deck_id INT DEFAULT NULL, card_id INT DEFAULT NULL, quantity SMALLINT NOT NULL, dice SMALLINT NOT NULL, INDEX IDX_5C5D6B9111948DC (deck_id), INDEX IDX_5C5D6B94ACC9A20 (card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS faction (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(1024) NOT NULL, is_primary TINYINT(1) NOT NULL, UNIQUE INDEX faction_code_idx (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS rarity (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(1024) NOT NULL, UNIQUE INDEX rarity_code_idx (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS oauth2_refresh_token (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, user_id INT DEFAULT NULL, token VARCHAR(255) NOT NULL, expires_at INT DEFAULT NULL, scope VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_4DD907325F37A13B (token), INDEX IDX_4DD9073219EB6921 (client_id), INDEX IDX_4DD90732A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS review (id INT AUTO_INCREMENT NOT NULL, card_id INT DEFAULT NULL, user_id INT DEFAULT NULL, date_creation DATETIME NOT NULL, date_update DATETIME NOT NULL, text_md LONGTEXT NOT NULL, text_html LONGTEXT NOT NULL, nb_votes SMALLINT NOT NULL, INDEX IDX_794381C64ACC9A20 (card_id), INDEX IDX_794381C6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS reviewvote (review_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_1B4C90573E2E969B (review_id), INDEX IDX_1B4C9057A76ED395 (user_id), PRIMARY KEY(review_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS reviewcomment (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, review_id INT DEFAULT NULL, date_creation DATETIME NOT NULL, date_update DATETIME NOT NULL, text LONGTEXT NOT NULL, INDEX IDX_E731F22FA76ED395 (user_id), INDEX IDX_E731F22F3E2E969B (review_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS cardset (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(1024) NOT NULL, position SMALLINT NOT NULL, size SMALLINT DEFAULT NULL, cgdb_id_start SMALLINT DEFAULT NULL, cgdb_id_end SMALLINT DEFAULT NULL, date_creation DATETIME NOT NULL, date_update DATETIME NOT NULL, date_release DATE DEFAULT NULL, UNIQUE INDEX pack_code_idx (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS side (id INT AUTO_INCREMENT NOT NULL, card_id INT DEFAULT NULL, type_id INT DEFAULT NULL, value SMALLINT NOT NULL, modifier SMALLINT DEFAULT NULL, cost SMALLINT DEFAULT NULL, date_creation DATETIME NOT NULL, date_update DATETIME NOT NULL, INDEX IDX_23811BB54ACC9A20 (card_id), INDEX IDX_23811BB5C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS sidetype (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(15) NOT NULL, icon VARCHAR(15) NOT NULL, name VARCHAR(1024) NOT NULL, UNIQUE INDEX sidetype_code_idx (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS starterpack (id INT AUTO_INCREMENT NOT NULL, set_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(50) NOT NULL, date_creation DATETIME NOT NULL, date_update DATETIME NOT NULL, INDEX IDX_231EFBB710FB0D18 (set_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS starterpackslot (id INT AUTO_INCREMENT NOT NULL, starterpack_id INT DEFAULT NULL, card_id INT DEFAULT NULL, quantity SMALLINT NOT NULL, dice SMALLINT NOT NULL, INDEX IDX_E31C84D8AB172893 (starterpack_id), INDEX IDX_E31C84D84ACC9A20 (card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS subtype (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(1024) NOT NULL, UNIQUE INDEX subtype_code_idx (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS type (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(1024) NOT NULL, UNIQUE INDEX type_code_idx (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, locked TINYINT(1) NOT NULL, expired TINYINT(1) NOT NULL, expires_at DATETIME DEFAULT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', credentials_expired TINYINT(1) NOT NULL, credentials_expire_at DATETIME DEFAULT NULL, date_creation DATETIME NOT NULL, date_update DATETIME NOT NULL, reputation INT NOT NULL, resume LONGTEXT DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, donation INT NOT NULL, notif_locale VARCHAR(255) DEFAULT \'en\' NOT NULL, is_notif_author TINYINT(1) DEFAULT \'1\' NOT NULL, is_notif_commenter TINYINT(1) DEFAULT \'1\' NOT NULL, is_notif_mention TINYINT(1) DEFAULT \'1\' NOT NULL, is_notif_follow TINYINT(1) DEFAULT \'1\' NOT NULL, is_notif_successor TINYINT(1) DEFAULT \'1\' NOT NULL, is_share_decks TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_8D93D64992FC23A8 (username_canonical), UNIQUE INDEX UNIQ_8D93D649A0D96FBF (email_canonical), UNIQUE INDEX UNIQ_8D93D649C05FB297 (confirmation_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS follow (following_id INT NOT NULL, follower_id INT NOT NULL, INDEX IDX_683444701816E3A3 (following_id), INDEX IDX_68344470AC24F853 (follower_id), PRIMARY KEY(following_id, follower_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
